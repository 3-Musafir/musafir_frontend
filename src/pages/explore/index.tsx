  ...
  return (
    <div className="min-h-screen w-full bg-gray-50">
      ...
      <main className="px-4 md:px-6 lg:px-8 xl:px-10 py-10 lg:py-14 space-y-12">
          ...
          <div className="grid gap-4 lg:gap-6 lg:grid-cols-3">
            {[
              ...
              <div key={item.title} className="rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <p className="text-sm text-text mt-2">{item.description}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="grid gap-4 lg:gap-6 lg:grid-cols-2">
            {[
              ...
              <Link
                key={item.title}
                href={item.href}
                className="group rounded-2xl border border-gray-200 bg-white p-6 transition hover:border-brand-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary"
              >
                <h3 className="text-base font-semibold text-heading">{item.title}</h3>
                <p className="text-sm text-text mt-2">{item.description}</p>
          ...
          <div className="grid gap-4 lg:gap-6 lg:grid-cols-2">
            {[
              ...
              <Link
                key={item.title}
                href={item.href}
                className="group rounded-2xl border border-gray-200/70 bg-white/70 p-6 text-text/90 transition hover:border-brand-primary/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary"
              >
                <h3 className="text-base font-semibold text-heading/90">{item.title}</h3>
                <p className="text-sm text-text/80 mt-2">{item.description}</p>
        ...
        <section className="rounded-2xl bg-orange-50/60 border border-orange-100 p-6 lg:p-8 space-y-3">
