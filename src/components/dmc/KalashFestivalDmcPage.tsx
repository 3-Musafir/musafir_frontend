...
import {
  kalashFestivalAddOns,
  kalashFestivalDetailedItinerary,
  kalashFestivalDirectAnswer,
  kalashFestivalExclusions,
  kalashFestivalFaqs,
  kalashFestivalHeroCopy,
  kalashFestivalIdealFor,
  kalashFestivalImportantNotes,
  kalashFestivalInclusions,
  kalashFestivalInternalLinks,
  kalashFestivalOpening,
  kalashFestivalPositioning,
  kalashFestivalQuickFacts,
  kalashFestivalSummaryItinerary,
  kalashFestivalTiming,
} from "./kalashFestivalContent";
...
function SectionHeading({
  ...
  return (
    <div className="mx-auto max-w-[820px] text-center">
      {label ? <p className="text-[14px] font-black uppercase text-[#ff3b0a]">{label}</p> : null}
      <h2 className="mx-auto mt-[14px] max-w-[800px] text-[30px] font-black leading-[1.08] text-[#2d2f49] md:text-[44px]">
        {title}
      </h2>
      {body ? (
        <p className="mx-auto mt-5 max-w-[720px] text-[15.5px] font-medium leading-[1.5] text-[#596173] md:text-[18px]">
          {body}
        </p>
      ) : null}
    </div>
...
export default function KalashFestivalDmcPage() {
  return (
      ...
      <div className="mx-auto min-h-screen w-full max-w-[500px] overflow-hidden bg-[#fffaf8] md:max-w-none">
        ...
        >
          <div className="relative h-[232px] w-full overflow-hidden bg-[#2f3143] grayscale md:order-2 md:aspect-[780/500] md:h-auto md:min-h-0 md:rounded-[28px]">
            <Image
              ...
              alt="Kalash Festival 2027 DMC itinerary in Chitral and the Kalash Valleys"
              fill
              priority
          ...
          <div className="relative px-[21px] pb-12 pt-[24px] md:order-1 md:flex md:min-h-[650px] md:flex-col md:justify-center md:px-0 md:py-0">
            <nav aria-label="Breadcrumb" className="mb-[19px] text-[13px] font-bold text-[#747b8c]">
              ...
              <span className="px-2 text-[#a0a5b0]">/</span>
              <span>Kalash Festival 2027</span>
            </nav>
            ...
            <h1 className="max-w-[455px] text-[39px] font-black leading-[1.16] text-[#2d2f49] md:max-w-none md:text-[54px] md:leading-[1.04] lg:text-[64px]">
              Kalash Festival 2027 DMC Itinerary for{" "}
              <span className="text-[#ff3b0a]">Chitral and the Kalash Valleys</span>
            </h1>
            ...
            <div className="mt-[25px]">
              <AnswerBlock>{kalashFestivalDirectAnswer}</AnswerBlock>
            </div>

            <div className="mt-[20px] flex flex-wrap gap-2 text-[13px] font-extrabold">
              {kalashFestivalInternalLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
            ...
            <div className="mt-[34px] grid gap-[12px] md:grid-cols-2">
              {kalashFestivalQuickFacts.map((fact) => (
                <div
                  key={fact.label}
        ...
        <section className="bg-white px-3 py-20 md:px-8 md:py-24 lg:px-12 xl:px-[calc((100vw-1180px)/2)]">
          <div className="grid gap-6 md:grid-cols-[0.85fr_1.15fr] md:items-start">
            <div>
              <p className="text-[14px] font-black uppercase text-[#ff3b0a]">SEO opening</p>
              <h2 className="mt-[14px] text-[32px] font-black leading-[1.12] text-[#2d2f49] md:text-[44px]">
                Kalash Festival 2027 Special Interest DMC Itinerary
              </h2>
            </div>
            <AnswerBlock>{kalashFestivalOpening}</AnswerBlock>
          </div>
        </section>

        <section className="bg-[#fffaf8] px-3 py-20 md:px-8 md:py-24 lg:px-12 xl:px-[calc((100vw-1180px)/2)]">
          <SectionHeading
            label="Festival timing"
            title="Kalash Chilam Joshi Festival 2027 is the strongest commercial product"
            body="The suggested travel window gives foreign agencies buffer before and after the main festival days, while keeping visible copy clear that final community rhythm must be reconfirmed."
          />
          <div className="mx-auto mt-[38px] max-w-[920px] rounded-[18px] border border-[#ffe0d7] bg-white px-[20px] py-[20px] shadow-[0_2px_8px_rgba(20,24,36,0.04)]">
            <CalendarDays size={25} strokeWidth={2.5} className="text-[#ff3b0a]" />
            <p className="mt-[14px] text-[15px] font-medium leading-[1.6] text-[#596173] md:text-[17px]">
              {kalashFestivalTiming}
            </p>
          </div>
        </section>
        ...
        <section className="bg-white px-3 py-20 md:px-8 md:py-24 lg:px-12 xl:px-[calc((100vw-1180px)/2)]">
          <SectionHeading
            label="Positioning"
            title="Built for culturally sensitive festival execution"
            body="The Kalash Festival needs local coordination, respectful access, route planning, and clear guest behavior management."
          />
          <div className="mx-auto mt-[38px] max-w-[940px] rounded-[18px] border border-[#ebe9e7] bg-[#fffdfc] px-[20px] py-[20px]">
            <p className="text-[15px] font-medium leading-[1.6] text-[#596173] md:text-[17px]">
              {kalashFestivalPositioning}
            </p>
          </div>
        </section>
        ...
        <section className="bg-[#fffaf8] px-3 py-20 md:px-8 md:py-24 lg:px-12 xl:px-[calc((100vw-1180px)/2)]">
          <SectionHeading
            ...
            title="Built for Chitral, Ayun, Bumburet, Rumbur, and festival travel"
            body="This itinerary is designed for agencies that need local execution for Chitral, Ayun, Bumburet, Rumbur, heritage stays, responsible cultural access, and slow travel during the Kalash Festival."
          />
          ...
          <div className="mt-[38px] grid gap-[14px] md:grid-cols-[0.9fr_1.1fr]">
            <article className="rounded-[18px] border border-[#ebe9e7] bg-white px-[20px] py-[20px] shadow-[0_2px_8px_rgba(20,24,36,0.04)]">
              ...
              <h3 className="mt-[14px] text-[20px] font-black leading-tight text-[#2d2f49]">
                Operating route
              </h3>
              <p className="mt-[9px] text-[15px] font-medium leading-[1.55] text-[#596173]">
                Islamabad to Chitral, Hindukush Sarai, Ayun, Bumburet Valley,
                Rumbur Valley, Chitral Town, and Islamabad.
              </p>
            </article>
            ...
            <div className="flex snap-x gap-[14px] overflow-x-auto pb-2 [-ms-overflow-style:none] [scrollbar-width:none] md:grid md:snap-none md:grid-cols-3 md:overflow-visible md:pb-0 [&::-webkit-scrollbar]:hidden">
              {kalashFestivalIdealFor.map((item) => (
                <article
                  key={item}
        ...
        >
          <SectionHeading
            ...
            title="10-day Kalash Festival 2027 DMC itinerary"
            body="A practical agency-ready route from Islamabad into Chitral and the Kalash Valleys, with careful pacing for culture, festival timing, road conditions, flight disruption, and responsible community access."
          />
          ...
          <div className="mt-[42px] flex snap-x gap-[14px] overflow-x-auto pb-2 [-ms-overflow-style:none] [scrollbar-width:none] md:grid md:snap-none md:grid-cols-2 md:overflow-visible md:pb-0 lg:grid-cols-5 [&::-webkit-scrollbar]:hidden">
            {kalashFestivalSummaryItinerary.map((item) => (
              <article
        ...
        <section className="bg-[#fffaf8] px-3 py-20 md:px-8 md:py-24 lg:px-12 xl:px-[calc((100vw-1180px)/2)]">
          <SectionHeading
            ...
            title="Day-by-day Kalash Festival cultural tour execution"
          ...
          <div className="mx-auto mt-[42px] max-w-[980px] space-y-[12px]">
            {kalashFestivalDetailedItinerary.map((item) => (
              <article
              ...
              >
                ...
                <div>
                  ...
                  <div className="mt-[15px] grid gap-3 md:grid-cols-2">
                    <div>
                      <p className="text-[12px] font-black uppercase text-[#2d2f49]">
        ...
        <section className="bg-white px-3 py-20 md:px-8 md:py-24 lg:px-12 xl:px-[calc((100vw-1180px)/2)]">
          ...
          <div className="mt-[42px] grid gap-[14px] md:grid-cols-3">
            {kalashFestivalAddOns.map((group) => (
              <article
                key={group.title}
        ...
        <section className="bg-[#fffaf8] px-3 py-20 md:px-8 md:py-24 lg:px-12 xl:px-[calc((100vw-1180px)/2)]">
          ...
          <div className="mt-[42px] grid gap-[18px] lg:grid-cols-[1fr_0.8fr]">
            <article className="rounded-[18px] border border-[#ebe9e7] bg-white px-[20px] py-[20px] shadow-[0_2px_8px_rgba(20,24,36,0.04)]">
              ...
              <ul className="mt-[15px] grid gap-[10px] md:grid-cols-2">
                {kalashFestivalInclusions.map((item) => (
            ...
            <article className="rounded-[18px] border border-[#ffd9cf] bg-[#fff4f0] px-[20px] py-[20px]">
              ...
              <ul className="mt-[15px] space-y-[11px]">
                {kalashFestivalExclusions.map((item) => (
                  <li key={item} className="flex gap-[10px] text-[14px] font-medium leading-[1.42] text-[#596173]">
          ...
          <div className="mt-[18px] grid gap-[12px] md:grid-cols-2 lg:grid-cols-3">
            {kalashFestivalImportantNotes.map((note) => (
        ...
        >
          ...
          <p className="mx-auto mt-[27px] max-w-[620px] text-center text-[17px] font-medium leading-[1.55] text-[#b9bdca] md:text-[18px]">
            Practical answers for agencies evaluating Kalash Festival dates, Chitral, Ayun,
            Bumburet, Rumbur, heritage stays, cultural sensitivity, and local DMC execution.
          </p>

          <div className="mt-[63px] space-y-[15px] md:mx-auto md:grid md:max-w-[960px] md:grid-cols-2 md:items-start md:gap-4 md:space-y-0">
            {kalashFestivalFaqs.map((faq) => (
        ...
        >
          <div className="rounded-[20px] border border-[#ebe9e7] bg-[#f8f8fa] px-[31px] pb-[25px] pt-[32px] shadow-[0_1px_4px_rgba(20,24,36,0.03)] md:px-8 md:py-8">
            <h2 className="text-[24px] font-black leading-tight text-[#2d2f49] md:text-[34px]">
              Partner with 3Musafir for Kalash Festival 2027
            </h2>
            <p className="mt-[17px] max-w-[720px] text-[13.5px] font-medium leading-[1.45] text-[#596173] md:text-[16px]">
              Share your agency brief and we will scope the route, festival timing assumptions,
              heritage stays, cultural access, transport, local guides, inclusions, exclusions,
              and Chitral ground handling requirements.
            </p>

            <a
              href="https://wa.me/923221848940?text=Hi%203Musafir%2C%20I%20want%20to%20partner%20for%20Kalash%20Festival%202027%20DMC%20services."
              target="_blank"
          ...
          <div className="rounded-[20px] border border-[#ffc9bb] bg-[#fff4f0] px-[31px] pb-[30px] pt-[27px] md:grid md:grid-cols-[0.8fr_1.2fr] md:gap-8 md:px-8 md:py-8 lg:gap-12">
            <div>
              ...
              <p className="mt-[31px] text-[15.5px] font-medium leading-[1.5] text-[#596173] md:text-[17px]">
                Use this contact path for cultural travel companies, festival tour operators,
                responsible tourism groups, and private international groups that need Kalash
                Festival 2027 logistics.
              </p>
            </div>

            <div className="mt-[28px] md:mt-0 md:flex md:items-center">
              <a
                href="https://wa.me/923221848940?text=Hi%203Musafir%2C%20I%20need%20a%20Kalash%20Festival%202027%20DMC%20itinerary%20for%20an%20agency%20group."
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="md:grid md:grid-cols-[1.1fr_0.9fr] md:gap-12">
            <div>
              ...
              <p className="mt-[23px] max-w-[460px] text-[15.5px] font-medium leading-[1.55] text-[#b9bdca] md:text-[16px]">
                Pakistan-based DMC support for Kalash Festival 2027 cultural programs,
            ...
            <div className="mt-[34px] grid grid-cols-2 gap-8 md:mt-0">
              <div>
                ...
                <ul className="mt-[22px] space-y-[14px] text-[14px] font-medium text-[#b9bdca]">
                  ...
                  <li><Link href="/pakistan-dmc/tours/skardu">Skardu DMC services</Link></li>
                </ul>
              </div>
              <div>
                <h3 className="text-[15px] font-black">Route</h3>
                <ul className="mt-[22px] space-y-[14px] text-[14px] font-medium text-[#b9bdca]">
                  <li><a href="#itinerary">Kalash Festival itinerary</a></li>
                  <li><a href="#urgent-enquiry">Request Kalash plan</a></li>
